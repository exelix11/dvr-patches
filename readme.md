...
**Only the following firmwares are supported: 13.2, 13.1, 13.0, 12.1, 11.0 and 11.0.1**. I have no plans to port to older firmwares, of course pull requests are welcome.
